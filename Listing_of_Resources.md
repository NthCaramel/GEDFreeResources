...
| Name of Resource | Link | Type of Resource | Remarks |
|---------|--------|-------|-------|
| Light and Salt | https://sites.google.com/view/gedmathcrashcourse/home | Video | Covers Math only |

## Social Studies

| Name of Resource | Link | Type of Resource | Remarks |
|---------|--------|-------|-------|
| Study.com | https://study.com/academy/course/ged-social-studies.html | Practice Questions | Does not necessarily require an account |
